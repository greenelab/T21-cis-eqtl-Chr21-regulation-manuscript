...
Whole blood transcriptome profiles used in this analysis are available through Synapse [@doi.org/10.7303/syn31488780], the INCLUDE Data Hub, and Gene Expression Omnibus (GSE190125).
...
The Broad Institute carried out paired-end whole genome sequencing (WGS) on Illumina HiSeqX with a target read depth of ~30x coverage[@doi:10.1002/gepi.70010].
...
Variants were called against the GRCh38 reference genome with Octopus v0.7.4 [@doi:10.1038/s41587-021-00861-3], using the individual caller on each sample independently and restricting calling to HSA21 (--regions chr21).
