...
comment: show gene-dosage-dependent increases for the title instead of rise?
...
comment: I think here we have to add the number of matched samples with RNA-Sseq and genetics similar than the previous paragraph.
...
comment: i missed an small conclusion after the results something like: In summary, after ploidy correction most assessable HSA21 genes showed the expected increase with gene dosage. Only 13 deviated. Common cis-eQTLs may explain 7 of these, but their small effect sizes suggest they explain only part of the deviation. The remaining six genes are candidates for other regulatory mechanisms.
