...
<!-- do we need the titles and subtitles in the plots or we can move the information to the captions? -->
...
<!-- deviating genes we defined this in methdos but I think a sentence here for the reader like We defined deviating genes as those whose expression differed from the expected 1.5-fold dosage effect by at least 33% (adjusted p < 0.01). -->
...
comment: one ref after OLIG2 is not correctly rendered
...
comment: I'd move the text in the boxes into a suupl table the text is too small, keeping the gene and the gtex agreement maybe is enough or with commenting this in the results and the table maybe is enough
same for the fig4
